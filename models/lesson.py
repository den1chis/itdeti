...
class Lesson(Base):
    ...
    event_id = Column(UUID(as_uuid=True), ForeignKey("events.id", ondelete="SET NULL"), nullable=True, unique=True)
    lesson_kind = Column(SAEnum("lesson", "masterclass", name="lesson_kind"), nullable=False, default="lesson")
    lesson_type = Column(SAEnum("regular", "trial", "extra", name="lesson_type"), nullable=False, default="regular")
    status = Column(SAEnum("scheduled", "completed", "cancelled", "rescheduled", name="lesson_status"), nullable=False, default="scheduled")
